					...
					for (LinkedList<String> fieldNames : tagNames) {
						...
						for(String fieldName : fieldNames){
							...
							if (fstNmElmnt != null) {
								...
								if(fieldName.equals("label") || fieldName.equals("masterLabel") || fieldName.equals("fullName") ){
									tempName = ((Node) fstNm.item(0)).getNodeValue();
								}
							} else {
								//if(fieldName.equals("description"))
									//tempResult += tempName;
									//partialResult.add(tempName);
								//else{ //if(fieldName.equals("obj")){
									//tempResult += objectName; 
									//partialResult.add(objectName);
								//}
								//else{
									tempResult += "";
									//partialResult.add("not specified");
								//}
							}
							iteratorTags++;
